...
3.  執行下列命令來識別將用來保護檔案的範本識別碼︰
    ...
    Get-RMSTemplate
    ```
    若要使用會對具有所有使用權限的所有員工限制存取的預設範本，請尋找範本名稱 &lt;組織名稱&gt; - 機密。 例如，VanArsdel, Ltd - 機密。
...
-   以一般將保護的檔案類型和檔案伺服器共用的名稱來取代 &lt;檔案類型及&gt; 和 &lt;檔案伺服器共用&gt;。

-   以您的組織名稱取代 &lt;組織名稱&gt;，因為它會在您的預設 Azure Rights Management 範本上顯示。

-   以您的組織名稱取代 &lt;組織名稱&gt;。

-   以此檔案類型的特定應用程式指示取代 &lt;指示如何儲存檔案及移除 .pfile 副檔名&gt;。
...
2.  您會看到來自 Microsoft Rights Management 共用應用程式的 [受保護的檔案] 對話方塊，它會告訴您，您應遵守 &lt;組織名稱&gt; - 機密的權限。 這表示，若他人未替 &lt;組織名稱&gt; 工作，請勿與其共用此文件。
...
2.  您會看到來自 Microsoft Rights Management 共用應用程式的 [受保護的檔案] 對話方塊，它會告訴您，您應遵守 VanArsdel, Ltd - 機密的權限。 這表示，若他人未替 VanArsdel, Ltd 工作，請勿與其共用此文件。
