...
如需支援 Azure Rights Management Service 的裝置清單，請參閱 [Azure RMS 需求：支援 Azure RMS 的用戶端裝置](../get-started/requirements-client-devices.md)。 目前並非所有支援的裝置都能支援所有 Rights Management 功能，因此請務必另外查看 [Azure RMS 需求：應用程式](../get-started/requirements-applications.md)中的表格。
