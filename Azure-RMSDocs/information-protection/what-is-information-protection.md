...
Azure Information Protection 可讓您分類、標記並保護您的文件和電子郵件。 當您分類此資料時，持續性的標籤會加入至資料，好讓分類可隨時識別，無論資料的儲存位置或與誰共用。 持續性的標籤包括視覺標記，例如頁首、頁尾或浮水印。 針對您最機密的資料，也可以使用 Azure Rights Management 加密、識別和授權原則，協助防止資料遺失。 
