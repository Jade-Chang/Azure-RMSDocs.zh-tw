...
title: Rights Management 共用應用程式：版本發行記錄 | Azure RMS
description:
keywords:
author: cabailey
manager: mbaldwin
...
-   只有檔案擁有者和具有共同擁有者權限層級的人員可以取消檔案的保護。 以前，擁有者和具有共同作者與共同擁有者權限層級的人員可以取消檔案保護。
...
-   當您選擇 [共用保護] 時的範本支援：
    ...
    -   您不會再看見 允許在所有裝置上使用 和 強制使用限制的選項。 根據檔案類型，會改為自動選取 [一般保護]  。
