...
若要設定針對指定授權的電子郵件通知，請使用 [IpcSetLicenseProperty](/rights-management/sdk/2.1/api/win/functions#msipc_ipcsetlicenseproperty) 搭配屬性型別參數 dwPropID做為 [IPC\_LI\_APP\_SPECIFIC\_DATA](/rights-management/sdk/2.1/api/win/License%20property%20types#msipc_license_property_types_IPC_LI_APP_SPECIFIC_DATA) 以及應用程式資料欄位，格式如 [IPC\_NAME\_VALUE\_LIST](/rights-management/sdk/2.1/api/win/structures#msipc_ipc_name_value_list)。
