...
此案例開始會取得範本清單，[MSTemplateDescriptor](https://stage.docs.microsoft.com/en-us/rights-management/sdk/4.2/api/iOS/iOS#msipcthin2_mstemplatedescriptor_interface_objc)，選取第一個來建立原則，然後建立並寫入至新的受保護檔案。
